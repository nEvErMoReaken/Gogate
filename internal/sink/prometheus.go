...
// Start Step.2
func (p *PrometheusStrategy) Start(pointChan chan *pkg.PointPackage) {
...
func (p *PrometheusStrategy) Publish(pointPackage *pkg.PointPackage) error {
	metrics := pkg.GetPerformanceMetrics() // 获取性能指标实例
